...
router.post(
  ...
  async (req, res) => {
    try {
      ...
      console.log("\n" + "=".repeat(80));
      console.log("➡️  WEBHOOK RECEIVED - Incoming Stripe webhook:", {
      ...
      // Log raw body info for debugging
      if (req.body) {
        console.log("📦 Request body info:", {
          type: typeof req.body,
          isBuffer: Buffer.isBuffer(req.body),
          length: req.body.length || 'N/A',
          firstChars: Buffer.isBuffer(req.body) ? req.body.toString().substring(0, 100) : 'N/A'
        });
      }
